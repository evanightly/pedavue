...
interface CourseInstructorCreateProps {}

export default function CourseInstructorCreate() {
  ...
  return (
    <AppLayout>
      ...
      <Form {...CourseInstructorController.store.form()}
        ...
        {({ errors, processing }) => (
          <div className="space-y-6 rounded-xl border bg-card p-8 shadow-sm">
            <div className="space-y-2">
              <h1 className="text-2xl font-semibold tracking-tight">Create Course Instructor</h1>
