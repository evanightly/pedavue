...
interface ModuleContentEditProps {
  record: ModuleContentRecord;
}

export default function ModuleContentEdit({ record }: ModuleContentEditProps) {
  ...
  const [moduleStageId, setModuleStageId] = useState<number | string | null>(() => {
    const direct = record?.module_stage_id;

    if (typeof direct === 'number' || typeof direct === 'string') {
      return direct;
    }

    const related = record?.module_stage;
  ...
  return (
    <AppLayout>
      <Head title="Edit Module Content" />
      <Form {...ModuleContentController.update.form(record.id)}
        ...
        {({ errors, processing }) => (
          <div className="space-y-6 rounded-xl border bg-card p-8 shadow-sm">
            <div className="space-y-2">
              <h1 className="text-2xl font-semibold tracking-tight">Edit Module Content</h1>
            ...
            <div className="grid gap-6">
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  name="file_path"
                  type="text"
                  defaultValue={normalizeFieldValue(record.file_path)}
                />
              ...
              <div className="grid gap-2">
                ...
                <Textarea
                  ...
                  name="content_url"
                  rows={4}
                  defaultValue={normalizeFieldValue(record.content_url) as string}
                />
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  type="text"
                  required
                  defaultValue={normalizeFieldValue(record.content_type)}
                />
