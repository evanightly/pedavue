                    ...
                    <div className='space-y-8'>
                                ...
                                <div className='flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between'>
                                    <div className='space-y-2'>
                                        ...
                                        {latestRequestMessage ? (
                                            <p className='text-sm text-muted-foreground italic'>“{latestRequestMessage}”</p>
                                        ) : null}
                                    </div>
                            ...
                            <div className='rounded-2xl border bg-card p-6 shadow-lg'>
                                <div className='flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between'>
                                    <div className='space-y-2'>
                                        ...
                                        <h2 className='text-xl font-semibold text-foreground'>Daftar untuk mengirim permintaan</h2>
                                        <p className='text-sm text-muted-foreground'>
                                            Buat akun siswa untuk mengajukan permintaan pendaftaran ke kursus ini. Setelah registrasi, Anda akan
                                            diarahkan kembali ke halaman ini dengan formulir pendaftaran terbuka secara otomatis.
                                        </p>
                                    </div>
                                    <div className='flex w-full flex-col gap-2 sm:w-auto sm:items-end'>
                                        <Button asChild className='w-full sm:w-auto'>
                                            <Link href={registerUrl}>Daftar sebagai siswa</Link>
                                        </Button>
                        ...
                        {hasCertificateTemplate ? (
                            ...
                            <div className='rounded-2xl border border-dashed bg-card/40 p-6 text-sm text-muted-foreground shadow-inner'>
                                Sertifikat diaktifkan, tetapi template belum diunggah. Unggah template di halaman edit kursus untuk menampilkan
                                pratinjau.
                            </div>
                        ) : null}
                            ...
                            <ul className='mt-6 space-y-3'>
                                {students.length === 0 ? (
                                    ...
                                    students.map((student) => {
                                        ...
                                        const displayName =
                                            typeof student?.name === 'string' && student.name.length > 0 ? student.name : 'Tanpa nama';
