...
export default function QuizResultAnswerIndex({
    quizResultAnswers,
    filters = null,
    sort = null,
    filteredData: initialFilteredData = null,
}: QuizResultAnswerIndexProps) {
    const resolveDestroyUrl = useCallback((id: number) => QuizResultAnswerController.destroy(id).url, []);
    const handleDelete = useCallback(
        (id: number) => {
            confirm.delete('This action cannot be undone. Delete this quiz result answer?', () => {
            ...
            <div className='container mx-auto py-8'>
                <div className='flex flex-col gap-4 md:flex-row md:items-center md:justify-between'>
                    ...
                    <div className='flex flex-wrap items-center gap-2 md:flex-nowrap'>
                        <Button asChild>
                            <Link href={QuizResultAnswerController.create().url}>New Quiz Result Answer</Link>
                        </Button>
                    </div>
                </div>
